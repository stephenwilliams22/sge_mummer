...
min_args=3
#path to the sge_mumer install directory:
script_path=/mnt/home/stephen/Apps/sge_mummer/
#path to the mumer install directory:
mummer_path=/mnt/home/stephen/.linuxbrew/Cellar/mummer/3.23/
